...
var createUser = function () {
    ...
    db_aruntest_db = require('../db/aruntest_db_schema.js');
    db_aruntest_db.User.count().exec(function (err, count) {
        if (count == 0) {
            var admin = new db_aruntest_db.User({
                username: 'admin',
