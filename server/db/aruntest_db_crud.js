 ...
 */
connectDB = function()  {
	const dbConnection_aruntest_db = mongoose.createConnection('mongodb://' + properties.aruntest_db_dbUrl, function(err){
		if(err) {
			logger.error(err);
			setTimeout(function() {
		...
		{
		    exports.connection = dbConnection_aruntest_db;
			logger.info("MongoDB connected at: " + properties.aruntest_db_dbUrl);
			
			//START IMPORT RESOURCE

			require('./aruntest_db_schema.js');

			require('../resource/aruntest_db/User.js');
